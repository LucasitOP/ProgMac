...
public class MainTienda {
	...
	public void VentaDeUnAnimal(Scanner sc, Animal[][] animales) {
	    ...
	    // Aquí podrías calcular el beneficio de la venta
	}

	public static double CalcularBeneficio(double beneficio,Animal[][]animales) {
